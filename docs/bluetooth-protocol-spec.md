...
| 获取循环任务 | `7E 03 01 02 52` | `7E [整体长度] 02 02 52 [任务数据]` (任务1) / `7E [整体长度] 02 02 52 [任务数据]` (任务2) / ... / `7E 03 02 02 53` (结束) | 03=整体长度（共3字节：02 51 01），01=方向（下行），02 51=命令码，[整体长度]=整体长度（根据任务数据字节数确定），02=方向（上行），02 52=响应命令码，02 53=结束命令码，逐个返回任务数据后以结束指令结尾 |
